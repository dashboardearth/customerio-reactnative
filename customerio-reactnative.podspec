...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/dashboardearth/customerio-ios.git", :tag => "#{s.version}" }
  ...
  s.dependency "CustomerIO-DashboardEarth/DataPipelines", package["cioNativeiOSSdkVersion"]
